...
def main():
    ...
    print(f"  - Environments: {', '.join([env.name for env in project.list_environments()])}")
    print(f"  - Experiments: {', '.join([exp.name for exp in project.list_experiments()])}")
    print(f"  - Registered Models: {', '.join([model.name for model in registry.list_models()])}")
